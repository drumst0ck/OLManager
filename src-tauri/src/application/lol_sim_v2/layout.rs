...
pub(super) const LANE_PATH_BOT_BLUE: [Vec2; 11] = [
    Vec2 { x: 0.12, y: 0.88 }, Vec2 { x: 0.24, y: 0.89 }, Vec2 { x: 0.36, y: 0.9 }, Vec2 { x: 0.49, y: 0.907 }, Vec2 { x: 0.62, y: 0.909 }, Vec2 { x: 0.72, y: 0.912 }, Vec2 { x: 0.81, y: 0.852 }, Vec2 { x: 0.89, y: 0.705 }, Vec2 { x: 0.91, y: 0.58 }, Vec2 { x: 0.91, y: 0.45 }, Vec2 { x: 0.89, y: 0.12 },
];
